...
<body>
    <div>
        ...
        try {
            ...
            //SQL文を作る
            $sql = "SELECT goods.id as goods_id, goods.name as goods_name, goods.size, brand.name as brand_name, stock.quantity FROM goods, brand, stock WHERE goods.brand = brand.id AND goods.id = stock.goods_id ORDER BY goods_name";
